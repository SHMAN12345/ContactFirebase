...
class MainActivity : AppCompatActivity() {
    ...
    private fun uploadContacts() {
        val sharePreferences=this.getPreferences(Context.MODE_PRIVATE)
        val id=sharePreferences.getString(getString(R.string.phone),"")

        if(id.isNullOrEmpty()){
            Toast.makeText(this,getString(R.string.upload_error),
